      ...
      <div class="row justify-content-md-left justify-content-sm-left">
        <div class="col-md-3 col-sm-6">
          <div class="product-grid">
              ...
              <div class="product-content">
                  <h3 class="title"><a href="#">strategi visual</a></h3>
        ...
        <div class="col-md-3 col-sm-6">
            <div class="product-grid">
                ...
                <div class="product-content">
                    <h3 class="title"><a href="#">aplikasi internet</a></h3>
        ...
        <div class="col-md-3 col-sm-6">
            <div class="product-grid">
                ...
                <div class="product-content">
                    <h3 class="title"><a href="#">filsafat ilmu</a></h3>
        ...
        <div class="col-md-3 col-sm-6">
          <div class="product-grid">
              ...
              <div class="product-content">
                  <h3 class="title"><a href="#">rasa</a></h3>
        ...
        <div class="col-md-3 col-sm-6">
            <div class="product-grid">
                ...
                <div class="product-content">
                    <h3 class="title"><a href="#">geografi kota dan desa</a></h3>
        ...
        <div class="col-md-3 col-sm-6">
            <div class="product-grid">
                ...
                <div class="product-content">
                    <h3 class="title"><a href="#">penelitian hukum</a></h3>
